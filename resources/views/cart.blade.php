@extends('master')
@section('title', __("Biolife - Shopping Cart"))
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-thumbnail" data-title="Product Name">
                                                ...
                                                <div class="action">
                                                    ...
                                                    <button data-token="{{ csrf_token() }}" data-id="{{ $orderDetail->rowId}}">
                                                        delete
                                                    </button>
                                                </div>
                                            </td>
                                            <td class="product-price" data-title="Price">
                                                <div class="price price-contain">
                                                    <ins><span class="price-amount"><span class="currencySymbol">£</span>{{$orderDetail->product->price}}</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">£</span>{{$orderDetail->product->price_cost}}</span></del>
                                                </div>
                                            </td>
                                            <td class="product-quantity" data-title="Quantity">
                                                <div class="quantity-box type1">
                                                    <div class="qty-input">
                                                        <input type="text" id="quantity" name="quantity" value="{{$orderDetail->quantity}}" data-max_value="20" data-min_value="1" data-step="1">
                                            ...
                                            <td class="product-subtotal" data-title="Total">
                                                <div class="price price-contain">
                                                    <ins><span class="price-amount"><span class="currencySymbol">£</span>{{ $orderDetail->total() }}</span></ins>
