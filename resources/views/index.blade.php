@extends('master')
@section('title', __('Biolife - Organic Food'))
                                    ...
                                    @foreach ($bestSellers as $pro)
                                        <li class="product-item">
                                            <div class="contain-product layout-default">
                                                ...
                                                <div class="info">
                                                    <b class="categories">{{ $pro->category->name }}</b>
                                                    <h4 class="product-title"><a  href="{{ route('product_detail', $pro->slug) }}"
                                                            class="pr-name">{{ $pro->name }}</a></h4>
                                                    <div class="price ">
                                                        <ins><span class="price-amount"><span
                                                                    class="currencySymbol">£</span>{{ $pro->price }}</span></ins>
                                                        <del><span class="price-amount"><span
                                                                    class="currencySymbol">£</span>{{ $pro->sale_price }}</span></del>
                                                    </div>
                                                    <div class="slide-down-box">
                                                        <p class="message">All products are carefully selected to ensure
                                                            food safety.</p>
                                                        <div class="buttons atcart">
                                                            <form action="{{ route('addToCart') }}" method="POST">
                                                                ...
                                                                <button class="btn add-to-cart-btn" style="width:100%;" type="submit">add to
                                                                    cart</button>
                                                                </a>
                                ...
                                <ul class="products biolife-carousel eq-height-contain nav-center-03 nav-none-on-mobile row-space-29px"
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product right-info-layout contain-product__right-info-layout">
                                            ...
                                            <div class="info">
                                                <b class="categories">{{$pro->category->name}}</b>
                                                <h4 class="product-title"><a  href="{{ route('product_detail', $pro->slug) }}" class="pr-name">{{$pro->name}}</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span
                                                        class="currencySymbol">£</span>{{ $pro->price }}</span></ins>
                                            <del><span class="price-amount"><span
